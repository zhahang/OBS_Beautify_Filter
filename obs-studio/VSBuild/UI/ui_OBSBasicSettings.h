...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 803, 1026));
        ...
        serviceWidget = new QWidget(widget_5);
        ...
        streamkeyPageLayout->setWidget(10, QFormLayout::FieldRole, ignoreRecommended);
        ...
        streamkeyPageLayout->setWidget(11, QFormLayout::FieldRole, enforceSettingsLabel);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 820, 677));
        ...
        simpleStreamingGroupBox = new QGroupBox(easyOutputsPage);
        ...
        simpleStreamingLayout->setWidget(1, QFormLayout::LabelRole, simpleOutStrEncoderLabel);
        ...
        simpleStreamingLayout->setWidget(1, QFormLayout::FieldRole, simpleOutStrEncoder);

        label_20 = new QLabel(simpleStreamingGroupBox);
        label_20->setObjectName(QString::fromUtf8("label_20"));

        simpleStreamingLayout->setWidget(2, QFormLayout::LabelRole, label_20);
        ...
        simpleStreamingLayout->setWidget(2, QFormLayout::FieldRole, simpleOutputABitrate);
        ...
        simpleStreamingLayout->setWidget(3, QFormLayout::FieldRole, simpleOutAdvanced);

        label_24 = new QLabel(simpleStreamingGroupBox);
        label_24->setObjectName(QString::fromUtf8("label_24"));
        label_24->setEnabled(true);

        simpleStreamingLayout->setWidget(4, QFormLayout::LabelRole, label_24);

        simpleOutPreset = new QComboBox(simpleStreamingGroupBox);
        simpleOutPreset->setObjectName(QString::fromUtf8("simpleOutPreset"));

        simpleStreamingLayout->setWidget(4, QFormLayout::FieldRole, simpleOutPreset);
        ...
        verticalLayout_3->addWidget(simpleStreamingGroupBox);
        ...
        sizePolicy6.setHeightForWidth(advRecTrackWidget->sizePolicy().hasHeightForWidth());
        advRecTrackWidget->setSizePolicy(sizePolicy6);
        ...
        sizePolicy2.setHeightForWidth(page_4->sizePolicy().hasHeightForWidth());
        page_4->setSizePolicy(sizePolicy2);
        ...
        formLayout_15->setWidget(7, QFormLayout::LabelRole, label_63);
        ...
        formLayout_15->setWidget(7, QFormLayout::FieldRole, advOutFFVGOPSize);
        ...
        formLayout_15->setWidget(8, QFormLayout::LabelRole, advOutFFUseRescale);
        ...
        formLayout_15->setWidget(8, QFormLayout::FieldRole, advOutFFRescale);
        ...
        formLayout_15->setWidget(9, QFormLayout::FieldRole, advOutFFIgnoreCompat);

        advOutFFVEncoder = new QComboBox(advOutRecFFmpeg);
        advOutFFVEncoder->setObjectName(QString::fromUtf8("advOutFFVEncoder"));

        formLayout_15->setWidget(10, QFormLayout::FieldRole, advOutFFVEncoder);

        label_37 = new QLabel(advOutRecFFmpeg);
        label_37->setObjectName(QString::fromUtf8("label_37"));

        formLayout_15->setWidget(10, QFormLayout::LabelRole, label_37);

        advOutFFVCfg = new QLineEdit(advOutRecFFmpeg);
        advOutFFVCfg->setObjectName(QString::fromUtf8("advOutFFVCfg"));

        formLayout_15->setWidget(11, QFormLayout::FieldRole, advOutFFVCfg);

        label_38 = new QLabel(advOutRecFFmpeg);
        label_38->setObjectName(QString::fromUtf8("label_38"));

        formLayout_15->setWidget(11, QFormLayout::LabelRole, label_38);
        ...
        formLayout_15->setWidget(12, QFormLayout::FieldRole, advOutFFABitrate);

        label_41 = new QLabel(advOutRecFFmpeg);
        label_41->setObjectName(QString::fromUtf8("label_41"));

        formLayout_15->setWidget(12, QFormLayout::LabelRole, label_41);
        ...
        formLayout_15->setWidget(13, QFormLayout::FieldRole, widget_10);

        label_47 = new QLabel(advOutRecFFmpeg);
        label_47->setObjectName(QString::fromUtf8("label_47"));

        formLayout_15->setWidget(13, QFormLayout::LabelRole, label_47);

        label_39 = new QLabel(advOutRecFFmpeg);
        label_39->setObjectName(QString::fromUtf8("label_39"));

        formLayout_15->setWidget(14, QFormLayout::LabelRole, label_39);

        advOutFFAEncoder = new QComboBox(advOutRecFFmpeg);
        advOutFFAEncoder->setObjectName(QString::fromUtf8("advOutFFAEncoder"));

        formLayout_15->setWidget(14, QFormLayout::FieldRole, advOutFFAEncoder);

        label_46 = new QLabel(advOutRecFFmpeg);
        label_46->setObjectName(QString::fromUtf8("label_46"));

        formLayout_15->setWidget(15, QFormLayout::LabelRole, label_46);

        advOutFFACfg = new QLineEdit(advOutRecFFmpeg);
        advOutFFACfg->setObjectName(QString::fromUtf8("advOutFFACfg"));

        formLayout_15->setWidget(15, QFormLayout::FieldRole, advOutFFACfg);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout_15->setItem(16, QFormLayout::FieldRole, verticalSpacer_3);
        ...
        scrollAreaWidgetContents_50->setGeometry(QRect(0, 0, 555, 469));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 602, 781));
        ...
        colorSpace->addItem(QString::fromUtf8("sRGB"));
        ...
        QWidget::setTabOrder(overflowSelectionHide, automaticSearch);
        ...
        QWidget::setTabOrder(advOutRecFormat, flvTrack1);
        QWidget::setTabOrder(flvTrack1, flvTrack2);
        QWidget::setTabOrder(flvTrack2, flvTrack3);
        QWidget::setTabOrder(flvTrack3, flvTrack4);
        QWidget::setTabOrder(flvTrack4, flvTrack5);
        QWidget::setTabOrder(flvTrack5, flvTrack6);
        QWidget::setTabOrder(flvTrack6, advOutRecTrack1);
        ...
        QWidget::setTabOrder(disableAudioDucking, baseResolution);
