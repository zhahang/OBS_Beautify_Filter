...
public:
    ...
    void setupUi(QMainWindow *OBSBasic)
    {
        ...
        sourceInteractButton->setMaximumSize(QSize(16777215, 22));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/res/images/interact.svg"), QSize(), QIcon::Normal, QIcon::Off);
        sourceInteractButton->setIcon(icon8);
        sourceInteractButton->setFlat(true);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/res/images/configuration21_16.png"), QSize(), QIcon::Normal, QIcon::Off);
        transitionProps->setIcon(icon9);
    ...
    void retranslateUi(QMainWindow *OBSBasic)
    {
        ...
        sourcePropertiesButton->setToolTip(QCoreApplication::translate("OBSBasic", "Properties", nullptr));
#endif // QT_CONFIG(tooltip)
        sourcePropertiesButton->setText(QCoreApplication::translate("OBSBasic", "Properties", nullptr));
#if QT_CONFIG(tooltip)
        sourceFiltersButton->setToolTip(QCoreApplication::translate("OBSBasic", "Filters", nullptr));
#endif // QT_CONFIG(tooltip)
