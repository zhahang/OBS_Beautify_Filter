...
def srgb_nonlinear_to_linear(u: 'float') -> "float":
    return _obspython.srgb_nonlinear_to_linear(u)
srgb_nonlinear_to_linear = _obspython.srgb_nonlinear_to_linear
...
def vec4_from_bgra_srgb(dst: 'vec4', bgra: 'uint32_t') -> "void":
    return _obspython.vec4_from_bgra_srgb(dst, bgra)
vec4_from_bgra_srgb = _obspython.vec4_from_bgra_srgb

def vec4_from_rgba_srgb_premultiply(dst: 'vec4', rgba: 'uint32_t') -> "void":
    return _obspython.vec4_from_rgba_srgb_premultiply(dst, rgba)
vec4_from_rgba_srgb_premultiply = _obspython.vec4_from_rgba_srgb_premultiply

def vec4_from_bgra_srgb_premultiply(dst: 'vec4', bgra: 'uint32_t') -> "void":
    return _obspython.vec4_from_bgra_srgb_premultiply(dst, bgra)
vec4_from_bgra_srgb_premultiply = _obspython.vec4_from_bgra_srgb_premultiply

def srgb_linear_to_nonlinear(u: 'float') -> "float":
    return _obspython.srgb_linear_to_nonlinear(u)
srgb_linear_to_nonlinear = _obspython.srgb_linear_to_nonlinear

def vec4_to_rgba_srgb(src: 'vec4') -> "uint32_t":
    return _obspython.vec4_to_rgba_srgb(src)
vec4_to_rgba_srgb = _obspython.vec4_to_rgba_srgb

def vec4_to_bgra_srgb(src: 'vec4') -> "uint32_t":
    return _obspython.vec4_to_bgra_srgb(src)
vec4_to_bgra_srgb = _obspython.vec4_to_bgra_srgb

def vec4_srgb_linear_to_nonlinear(dst: 'vec4') -> "void":
    return _obspython.vec4_srgb_linear_to_nonlinear(dst)
vec4_srgb_linear_to_nonlinear = _obspython.vec4_srgb_linear_to_nonlinear
