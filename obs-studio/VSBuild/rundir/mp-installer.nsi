...
!define INSTALL64
; !define ENABLE_OBS_BROWSER
; !define CHECK_VS2019_RUNTIME

!ifndef APPVERSION
!define APPVERSION "26.1.2"
!define SHORTVERSION "26.1.2"
!endif
...
!ifdef INSTALL64
 OutFile "TD-OBS-Studio-${SHORTVERSION}-Installer-x64.exe"
!else
